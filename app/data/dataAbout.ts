...
export const socialLinks: SocialLink[] = [
  ...
  { platform: "LinkedIn", url: "https://linkedin.com/in/torcoroma", icon: Linkedin, color: "bg-purple-700" },
  { platform: "Twitter", url: "https://twitter.com/torcoroma", icon: Twitter, color: "bg-purple-400" }
];