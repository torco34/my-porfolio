...
export default function CompactFinalCTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br  bg-[#574964] rounded-2xl shadow-xl p-6 md:p-8 text-white">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="mt-6 pt-4 border-t border-white/10">
              <p className="text-xs opacity-70">{t("footerText")}</p>
            </div>
          </div>
        </div>
      </div>
