        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {technologies.map((tech) => {
            ...
            return (
              ...
              >
                {/* Tarjeta principal */}
                <div className={`${tech.bgColor} rounded-2xl p-4 border border-gray-200/50 shadow-sm transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg cursor-pointer`}>
                  {/* Icono con gradiente */}
                  <div className="relative mb-3">
                    <div className={`absolute inset-0 bg-gradient-to-br ${tech.color} rounded-xl blur opacity-20`}></div>
                    <div className="relative flex items-center justify-center">
                      <Icon className={`w-8 h-8 bg-gradient-to-br ${tech.color} bg-clip-text text-transparent`} />
                    </div>
                  </div>
