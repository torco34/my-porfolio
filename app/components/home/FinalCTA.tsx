...
//   return (
//     <section className="relative overflow-hidden bg-linear-to-br from-gray-900  to-[#5a256e] rounded-3xl shadow-2xl p-8 md:p-12 text-white">
...
//             <div className="mb-8">
//               <p className="text-lg opacity-90 mb-6">{t("ctaText")}</p>
...
//               <p className="text-sm opacity-70">{t("footerText")}</p>
//             </div>
//           </div>
//         </div>
//       </div>
